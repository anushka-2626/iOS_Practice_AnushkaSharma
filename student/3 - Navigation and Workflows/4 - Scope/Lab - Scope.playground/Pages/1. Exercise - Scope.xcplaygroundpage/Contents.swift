...
//print("The value of foo is \(foo)")
print("it would how error because the variable is defined in the loop scope and cannot be accessed outside of it")
...
print("x is defined outside the loop and it can be accessed anywhere throughout the code meanwhile foo shows error because the variable is defined in the loop scope and cannot be accessed outside of it")
