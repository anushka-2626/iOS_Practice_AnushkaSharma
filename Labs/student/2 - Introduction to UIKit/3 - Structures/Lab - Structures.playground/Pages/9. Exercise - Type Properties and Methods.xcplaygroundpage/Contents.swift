...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "anu", email: "anu@gmail.com", age: 25)
    static func logIn(user: User) {
        currentUser = user
        print("\(user.userName) has logged in")
    }
}
var user = User(userName: "John Doe", email: "johndoe@example.com", age: 30)
print(user.userName)
User.init(userName: "Jane Doe", email: "janedoe@example.com", age: 25)
 ...
 */
var newUser = User(userName: "anu", email: "anu@gmail.com", age: 25)
